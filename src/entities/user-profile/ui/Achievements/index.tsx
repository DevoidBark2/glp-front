...
export const UserAchievements = () => {
    const [userProgress, setUserProgress] = useState(6); // Пример: пользователь прошёл 6 курсов
        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {achievements.map((achieve, index) => (
                    <div key={index} className="bg-gray-800 p-4 rounded-lg shadow-md flex items-center flex-col">
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full bg-gray-700 rounded-full h-2 mb-2">
                                <div
                                    ...
                                    style={{
                                        width: `${Math.min(getProgressPercentage(userProgress, achieve.required), 100)}%`,
                                    }}
                                ></div>
                            </div>
                            <p className="text-sm text-gray-400">
                                {userProgress} / {achieve.required} курсов
                            </p>
                        </div>
                    </div>
                ))}
