                ...
                <div className="flex justify-between container mx-auto items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex ml-10 space-x-5">
                            ...
                            <Link
                                href="/courses"
                                className={`text-white text-lg hover:text-yellow-300 transition-transform transform hover:scale-105 ${pathName === "/courses" ? "border-b-2 border-yellow-300" : ""
                                    }`}
                            >
                                Курсы
                            </Link>
                            <Link
                                href="/my-courses"
                                className={`text-white text-lg hover:text-yellow-300 transition-transform transform hover:scale-105 ${pathName === "/my-courses" ? "border-b-2 border-yellow-300" : ""
                                    }`}
                            >
                                Мои Курсы
                            </Link>
                            <Link
                                href="/forum"
                                className={`text-white text-lg hover:text-yellow-300 transition-transform transform hover:scale-105 ${pathName === "/forum" ? "border-b-2 border-yellow-300" : ""
                                    }`}
                            >
                                Форум
                            </Link>
                            <Link
                                href="/rating"
                                className={`text-white text-lg hover:text-yellow-300 transition-transform transform hover:scale-105 ${pathName === "/rating" ? "border-b-2 border-yellow-300" : ""
                                    }`}
                            >
                                Рейтинг
                            </Link>
                            <Link
                                href="/help"
                                className={`text-white text-lg hover:text-yellow-300 transition-transform transform hover:scale-105 ${pathName === "/help" ? "border-b-2 border-yellow-300" : ""
                                    }`}
                            >
                                Помощь
                            </Link>
