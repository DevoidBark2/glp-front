...
export const submitExamUserAnswer = async (courseId: number, examId: number) => {
    const data = (await axiosInstance.post(`api/submit-exam-user?examId=${examId}&courseId=${courseId}`)).data
